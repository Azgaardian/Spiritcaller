BINDING_HEADER_SPIRITCALLER = "SPIRITCALLER"
-- This statement will load any translation that is present or default to English.
if( not ace:LoadTranslation("SPIRITCALLER") ) then

	SPIRITCALLER_MSG_COLOR		= "|cffcceebb";
	Spieircaller_MSG_COLOR		= "|cffcceebb";
	SPIRITCALLER_DISPLAY_OPTION	= "[|cfff5f530%s|cff0099CC]";

	SPIRITCALLER_CONST = {

		Title   		= "SPIRITCALLER",
		Version 		= "0.7",
		Desc    		= "SPIRITCALLER Shaman Helper",
		Timerheader		= "Shaman Timers",
		UpdateInterval		= 0.2,
	
		ChatCmd		= {"/spirit", "/spiritcaller"},
